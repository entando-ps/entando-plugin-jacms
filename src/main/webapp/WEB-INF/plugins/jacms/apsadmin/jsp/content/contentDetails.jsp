                                ...
                                <div class="panel panel-default" id="tab-container"><%-- panel --%>
                                    <div class="panel-body"><%-- panel body --%>
                                        <div class="tab-content"><%-- tabs content --%>
                                            <%-- lang iterator --%>
                                            <s:iterator var="lang" value="langs" status="langStatusVar">
                                                <div id="<s:property value="#lang.code" />_tab" class="tab-pane <s:if test="#langStatusVar.first"> active </s:if>"><%-- tab --%>
                                                        <h3 class="sr-only">
                                                        <s:property value="#lang.descr" /> (<a class="backLink" href="#quickmenu" id="<s:property value="#lang.code" />_tab_quickmenu">
                                                            <s:text name="note.goBackToQuickMenu" />
                                                        </a>)
                                                    </h3>
                                                    <%-- content.attributeList iterator --%>
                                                    <s:iterator value="content.attributeList" var="attribute" status="attributeListStatus">
                                                        <%-- form-group --%>
                                                        <div class="form-group">
